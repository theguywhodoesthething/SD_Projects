...
public class State5 {
	...
	// constructor
	public State5(String name, String abbreviation, String capital) {
		setName(name);
		setAbbreviation(abbreviation);
		setCapital(capital);
	}

	public State5(String name, String abbreviation, String capital, int population) {
		setName(name);
		setAbbreviation(abbreviation);
		setCapital(capital);
